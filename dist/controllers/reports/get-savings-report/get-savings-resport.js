...
exports.GetSavingsReportController = void 0;
const helpers_1 = require("../../helpers");
class GetSavingsReportController {
    ...
    handle(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const savings = yield this.getReportRepository.getReport(body, "spending");
...
exports.GetSavingsReportController = GetSavingsReportController;
