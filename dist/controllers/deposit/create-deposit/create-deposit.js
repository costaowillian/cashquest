        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                for (const field of requiredFields) {
                    const fieldValue = (_a = httpRequest === null || httpRequest === void 0 ? void 0 : httpRequest.body) === null || _a === void 0 ? void 0 : _a[field];
                    if (typeof fieldValue === 'string' && !fieldValue.length) {
                        return (0, helpers_1.badRequest)(`Field ${field} is requires`);
                    }
                }
