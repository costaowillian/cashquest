...
router.get("/spending/:id", checkToken_1.chectToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const mongoGetSpendingRepository = new mongo_get_spending_1.MongoGetSpendingRepository();
    const getSpendingController = new get_spending_1.GetSpendingsController(mongoGetSpendingRepository);
    const { body, statusCode } = yield getSpendingController.handle({ params: req.params });
    res.status(statusCode).send(body);
}));
router.post("/spending/create", checkToken_1.chectToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { body, statusCode } = yield createSpendingController.handle({ body: req.body });
    res.status(statusCode).send(body);
}));
