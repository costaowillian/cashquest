...
class MongoDeleteSpendingRepository {
    deleteSpending(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const spending = yield mongo_1.MongoClient.db.collection("spending").findOne({ _id: new mongodb_1.ObjectId(id) });
            if (!spending) {
                throw new Error("Spending not found");
            }
            const { deletedCount } = yield mongo_1.MongoClient.db.collection("spending").deleteOne({ _id: new mongodb_1.ObjectId(id) });
            if (!deletedCount) {
